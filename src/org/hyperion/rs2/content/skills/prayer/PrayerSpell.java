...
public enum PrayerSpell {
	...
	RAPID_RESTORE(21, new int[] {PrayerManager.SKILLS_NONE}),
	RAPID_HEAL(23, new int[] {Skills.HITPOINTS}),
	PROTECT_ITEM(25, new int[] {PrayerManager.SKILLS_NONE}),
	...
	PROTECT_FROM_MAGIC(37, new int[] {PrayerManager.SKILLS_NONE}),
	PROTECT_FROM_MISSILES(39, new int[] {PrayerManager.SKILLS_NONE}),
	PROTECT_FROM_MELEE(41, new int[] {PrayerManager.SKILLS_NONE}),
	EAGLE_EYE(43, new int[] {Skills.RANGE}),
	MYSTIC_MIGHT(45, new int[] {Skills.MAGIC}),
	RETRIBUTION(47, new int[] {PrayerManager.SKILLS_NONE}),
	REDEMPTION(49, new int[] {Skills.HITPOINTS}),
	SMITE(51, new int[] {PrayerManager.SKILLS_NONE}),
